...
public interface EnvironmentVariables extends IndexParameters {
	...
	static final String LOCAL_PATH =
			"file:/root/uqdalves/my-data";
						
	// path to the data set folders/files 
	static final String DATA_PATH =
			/*
			LOCAL_PATH + "/trajectory-data-mercator/split1," + 
			LOCAL_PATH + "/trajectory-data-mercator/split2," +
			LOCAL_PATH + "/trajectory-data-mercator/split3," +
			LOCAL_PATH + "/trajectory-data-mercator/split4";
			*/
	...
	static final int NUM_PARTITIONS_DATA = 720; // number of data blocks: 180 360 540 720 ... 1440 
