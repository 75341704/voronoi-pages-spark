...
public class SelectionQueryCalculator implements Serializable, EnvironmentVariables, IndexParamInterface {
	private VoronoiPagesRDD pagesRDD;
	private Broadcast<VoronoiDiagram> diagram;

	/**
	 * Constructor. Receives the PagesRDD (data partition) 
	 * and a copy of the Voronoi diagram (index).
	 */
	...
	/**
	 * Given a rectangular geographic region, and a time interval
	 * from t0 to t1, return all trajectories that overlap with
	 * the given region and time interval [t0, t1].
	 * 
	 * @return Return a list of sub-trajectories that satisfy the query.
	 */
	...
	/**
	 * Given a time interval from t0 to t1, return all trajectories that
	 * overlap with the time interval, that is, return all sub-trajectories 
	 * that have been active during [t0, t1].
	 * 
	 * @return Return a list of sub-trajectories that satisfy the query.
	 */
	public List<Trajectory> getTimeIntervalSelection(
	...
	/**
	 * Given a rectangular geographic region, and a time interval
	 * from t0 to t1, return the ID of all trajectories that overlap 
	 * with the given region and time interval [t0, t1].
	 * 
	 * @return Return a list of trajectories IDs.
	 */
	public List<String> getSpatialTemporalSelectionId(
			final Box region, 
			final long t0, final long t1){
		/*******************
		 *  FILTERING STEP:
	...
	/**
	 * Given a rectangular geographic region, return the IDs 
	 * of all trajectories that overlap with the given region.
	 * 
	 * @return Return a list of trajectories IDs.
	 */
	public List<String> getSpatialSelectionId(
			final Box region){
		/*******************
		 *  FILTERING STEP:
		 *******************/
	...
	/**
	 * Given a time interval from t0 to t1, return the IDs of all 
	 * trajectories that overlap with the time interval, that is, 
	 * trajectories that have been active during [t0, t1].
	 * 
	 * @return Return a list of trajectories IDs.
	 */
	public List<String> getTemporalSelectionId (
			final long t0, final long t1){
		/*******************
		 *  FILTERING STEP:
		 *******************/
