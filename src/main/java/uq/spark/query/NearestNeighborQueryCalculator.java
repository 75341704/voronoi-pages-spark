...
public class NearestNeighborQueryCalculator implements Serializable, EnvironmentVariables, IndexParamInterface {
	...
	private final TrajectoryDistanceCalculator edwp = 
	 ...
	 */
	public Iterator<Trajectory> getReverseNearestNeighbors( 
			final Trajectory q, 
			final long t0, final long t1){
